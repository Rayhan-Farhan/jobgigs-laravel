    ...
    <div class="z-10">
        ...
        <div>
            {{-- <a href="/register"
                ...
                Up to List a Gig</a> --}}
            @auth
                <a href="/listings/manage" class="inline-block border-2 border-white text-white py-2 px-4 rounded-xl uppercase mt-2 hover:text-black hover:border-black">Manage Your List</a>
            @else
                <a href="/register"
                    class="inline-block border-2 border-white text-white py-2 px-4 rounded-xl uppercase mt-2 hover:text-black hover:border-black">Sign
                    Up to List a Gig</a>
